...
void do_disass(int r0, int r1, int r2, int pc)
{
  int OP = r0 * 2;
  printf("%x: ", pc);
  ...
  switch(AD[OP+1])
  {
    ...
    case Im: printf("%s #$%x\n",MN[AD[OP]],r1);break;
    case Zp: printf("%s $%x\n",MN[AD[OP]], r1);break;
    case Zx: printf("%s $%x, X\n",MN[AD[OP]],r1);break;
    case Zy: printf("%s $%x, Y\n",MN[AD[OP]],r1);break;
    case Ix: printf("%s ($x, X)\n",MN[AD[OP]],r1);break;
    case Iy: printf("%s ($%x), Y\n",MN[AD[OP]],r1);break;

    case Ab: printf("%s $%x\n",MN[AD[OP]],r2*256 + r1);break;
    case Ax: printf("%s $%x, X\n",MN[AD[OP]],r2*256 + r1);break;
    case Ay: printf("%s $%x, Y\n",MN[AD[OP]],r2*256+r1);break;
    case In: printf("%s ($%x)\n",MN[AD[OP]],r2*256+r1);break;

    default: printf(".db $%x <Invalid OPcode>\n",r0);
  }
